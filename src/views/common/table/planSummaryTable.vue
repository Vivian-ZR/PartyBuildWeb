<template>
  <table>
    ...
    <tr class="table-tr-mouseover" v-for="item in list" :key="item.id">
      ...
      <td :value="item.id"><router-link :to="{path: '/planSummaryArchives', query:{id:item.id, url:'/planSummary', navTitleStyle:'navTitleOne'}}" class="table-details">详情</router-link></td>
    </tr>
  </table>
</template>
