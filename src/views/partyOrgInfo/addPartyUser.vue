    ...
    <div class="user-message-body">
      ...
      <div class="user-message-add-user">
        <div>
          ...
          <span class="user-message-add-user-title">档案添加</span>
        </div>
        <div class="add-patry-user-title">党员信息录入</div>
...
import { getOrglist, getOrgPosition, postSavePartyMember } from "../../api/api";
export default {
  name: "addPartyUser",
  data() {
    return {
