<template>
  <div>
    ...
    <user-nav 
      ...
      :navTitleTwoRouter="'/democraticMessage'"
    ></user-nav>
    <!-- 侧边导航栏 -->
...
import democraticTable from './../common/table/democraticTable'
import { getDemocratic } from './../../api/api'
export default {
 name: 'democratic',
 data () {
   return {
    selectChoise: ['标题', '组织', '发布人'],
    header: ['标题', '组织', '公示周期', '发布人', '发布时间', '详情'],
    newsTable: [],
