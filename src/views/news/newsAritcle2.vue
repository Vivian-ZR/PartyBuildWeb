<template>
  <div>
    <!-- top信息栏 -->
    <user-nav :nvaTitleOut="true" :nvaTitleOneOut="'新闻总汇'" :nvaTitleTwoOutOne="'新闻详情'" :nvaTitleTwoOutStyle="'navTitleOne'"></user-nav>
    <!-- 侧边导航栏 -->
    ...
    <div class="user-message-add-body">
      <div class="user-message-add-from">
        ...
        <router-link to="/newslist" class="user-message-add-return">返回新闻总汇</router-link>
